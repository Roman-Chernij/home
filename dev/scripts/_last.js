...
function Burger() {
    ...
    //this.menu = this.burger.querySelector('.js-menu-page');
    //this.cancel = this.burger.querySelector('.js-cancel-page');
    this.burgerStyle();
...
Burger.prototype.addEvent = function (e) {
    ...
    //if(this.targetIcon.classList.contains("js-menu")) ? this.menuShow.bind(this):this.menuHide.bind(this);
    this.parent = this.targetIcon.parentElement;
    this.dataAttr = this.parent.getAttribute('data-num');
...
function MobiNav() {
    this.mobiBox = document.querySelector('#mobi-menu');
    this.navList = document.querySelector('.nav-menu');
    this.burger = document.querySelector('.burger-page');
    console.log(this.burger);
    this.burger.addEventListener('click', this.menuPage.bind(this));
}

MobiNav.prototype.menuPage = function () {
    clone = this.navList.cloneNode(true);
    this.width = this.mobiBox.clientWidth;
    this.body = document.querySelector('.boby');
    this.navList.classList.add('mobi-nav-show');
    this.body.style.cssText +="transform:translateX("+this.width+"px) transition: transform ease-in-out 1s";
    //this.mobiBox.style.cssText +="left:-"+this.width+"px"
};
